...
class the_seer_rx_flow_3P(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Rx Antenna Array - 3AA - Only Power: The Seer")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Rx Antenna Array - 3AA - Only Power: The Seer")
        ...
        self.settings = Qt.QSettings("GNU Radio", "the_seer_rx_flow_3P")
        ...
        self.connect((self.analog_const_source_x_0, 0), (self.qtgui_sink_x_0, 0))
...
def main(top_block_cls=the_seer_rx_flow_3P, options=None):
