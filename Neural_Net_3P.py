...
## Neural Network - 3 Antenna Array, Power Only - Final Model                                          ####
...
# Use "Neural_Net_3Pr_Test.py" to dial in the best model for the target problem.
...
if (choice == 1):
	...
	X_validate = validation_data[:,0:3]
	y_validate = validation_data[:,3:]
